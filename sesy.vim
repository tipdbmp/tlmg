...
nmap <F7> :set syntax=javascript
nmap <F6> :set syntax=html
nmap <F5> :set syntax=perl
nmap <Down> gj
nmap <Up> gk
...
silent only
cd ~/xdir/javascript/i
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 index.html
badd +48 static/js/main.js
badd +1 static/css/main.css
args index.html
edit index.html
...
wincmd t
set winheight=1 winwidth=1
exe 'vert 1resize ' . ((&columns * 44 + 97) / 194)
exe 'vert 2resize ' . ((&columns * 149 + 97) / 194)
argglobal
let s:cpo_save=&cpo
set cpo&vim
...
3
normal! 0
lcd ~/xdir/javascript/i
wincmd w
argglobal
edit ~/xdir/javascript/i/static/js/main.js
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal balloonexpr=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 72 - ((53 * winheight(0) + 27) / 55)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
72
...
exe 'vert 1resize ' . ((&columns * 44 + 97) / 194)
exe 'vert 2resize ' . ((&columns * 149 + 97) / 194)
tabedit ~/xdir/javascript/i/static/css/main.css
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
